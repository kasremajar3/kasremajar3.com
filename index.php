        ...
        <div class="container-fluid">
          <div class="row">
            <?php if ($_SESSION['id_jabatan'] == '1') : ?>
              <div class="col-lg-4">
                <div class="card shadow">
                  <div class="card-body">
                    <h5><i class="fas fa-address-book"></i> Jabatan</h5>
              ...
              <div class="col-lg-4">
                <div class="card shadow">
                  <div class="card-body">
                    <h5><i class="fas fa-fw fa-user-tie"></i> Pengurus</h5>
                    <h6 class="text-muted">Jumlah Pengurus: <?= $jml_user; ?></h6>
            ...
            <div class="col-lg-4">
              <div class="card shadow">
                <div class="card-body">
                  <h5><i class="fas fa-fw fa-users"></i> Remaja</h5>
                  <h6 class="text-muted">Jumlah Remaja: <?= $jml_siswa; ?></h6>
            ...
            <div class="col-lg-4">
              <div class="card shadow">
                <div class="card-body">
                  ...
                  <h6 class="text-muted">Jumlah Uang Kas: Rp. <?= number_format($jml_uang_kas + $jml_pendapatan - $jml_pengeluaran); ?></h6>
