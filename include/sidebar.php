...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
    <img src="assets/img/img_properties/r3.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">UANG KAS REMAJA</span>
  </a>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <li class="nav-item has-treeview menu-open">
          <a href="profile.php" class="nav-link"><i class="nav-icon fas fa-fw fa-user"></i> <p><?= $dataUser['nama_lengkap']; ?></p></a>
        </li>
        ...
        <li class="nav-item">
          <div class="bg-success nav-link text-white">
            ...
            <p>
              Sisa Uang: <?= number_format($jml_uang_kas + $jml_pendapatan - $jml_pengeluaran); ?>
            </p>
          </div>
        </li>
        <li class="nav-item has-treeview menu-open">
        ...
        <li class="nav-item">
          <a href="riwayat_pendapatan.php" class="nav-link">
            <i class="fas fa-stopwatch nav-icon"></i>
            <p>Riwayat Pendapatan</p>
          </a>
        </li>
        <li class="nav-item">
